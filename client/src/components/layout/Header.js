                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Accueil</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>catégories</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>produits</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Actualités</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Qui Sommes-Nous</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>FAQ</Link>
                      </li>
                      <li>
